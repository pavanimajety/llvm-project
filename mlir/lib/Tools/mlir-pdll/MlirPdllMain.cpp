...
//===----------------------------------------------------------------------===//
///
/// This is a utility that provides custom front-end language for pattern
/// rewrites targeting MLIR.
///
//===----------------------------------------------------------------------===//
...
#include "mlir/Tools/mlir-pdll/MlirPdllMain.h"
...
int mlir::MlirPdllMain(int argc, char **argv) {
